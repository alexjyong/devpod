...
func SetGlobalFlags(flags *flag.FlagSet) *GlobalFlags {
	...
	flags.StringVar(&globalFlags.DevPodHome, "devpod-secrets-home", "", "If defined will override the default devpod secrets home. You can also use DEVPOD_SECRETS_HOME to set this")
